                            ...
                            oni_reg_val_t value)
{
    ...
    switch (reg) {
        ...
        case ONI_CONFIG_RUNNING:
            // TODO: To do this, we need data to be produce on a sepatate thread
                           ...
                           oni_reg_val_t *value)
{
    ...
    switch (reg) {
        ...
        case ONI_CONFIG_TRIG:
            ...
            // implementaiton, this must reflect that
            *value = 0;
            break;
        case ONI_CONFIG_RUNNING:
...
static void _fill_read_buffer(oni_test_ctx ctx, uint32_t *data, size_t num_words)
{
    ...
    for (i = 0;
        ...
        // Header
        *(data + i) = ctx->dev_table[d].dev.idx;
        *(data + i + 1) = ctx->dev_table[d].dev.read_size;
        *((uint64_t *)(data + i + 2)) = ctx->frame_num++;
